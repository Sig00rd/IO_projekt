...
CREATE TABLE IF NOT EXISTS `invitation`(
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_invitation_sender1_idx` (`sender_id` ASC) VISIBLE,
  INDEX `fk_invitation_receiver1_idx` (`receiver_id` ASC) VISIBLE,
  INDEX `fk_invitation_game1_idx` (`game_id` ASC) VISIBLE,
  CONSTRAINT `fk_invitation_sender1`
    FOREIGN KEY (`sender_id`)
    REFERENCES `user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_invitation_receiver1`
    FOREIGN KEY (`receiver_id`)
    REFERENCES `user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_invitation_game1`
    FOREIGN KEY (`game_id`)
    REFERENCES `game` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)  
